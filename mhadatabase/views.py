...
from .models import (Equipment, Equipment2, Man, Type, BTUcond, BTUevap, Warr, \
    ...
    Mfgmodeldescripcond, Mfgmodeldescripevap, CurrentJobInfo, \
    Evapeff, Condeff, Filtereff, FilterMfgmodeldescrip, ManFilter, EffFilter, Config, Eff, \
    ...
    FilterCoiltype, FilterEquipType, OutsideResource, MatTypeBid, TechLevel, TechHours, \
    InstallPackage1, \
    ...
    TargetProfit, Mfgmodeldescriptherm, Descriptiontherm, ConfigTherm, Thermeff, Gasvivtherm,
    Filtermodelnum, \
    SmartThermostat, FilterPlenumWidth, ExistFurnConfig, YesNo, DetailTable, Terms, Quanity, MatType, \
    Material2, Material3)
...
def changelaborrate(request, id=None):
    form = TechLevel.objects.get(id=id)
    instance = TechLevel.objects.get(id=id)
    a = request.POST['id_rate']
    b = TechLevel.objects.filter(id=id).update(rate=a)
    context = {
        "instance": instance,
        "form": form,
        "b": b,
    }
    return render(request, 'mha/changetechrate.html', context)


def changetechrate(request, id=None):
    instance = TechLevel.objects.get(id=id)
    form = TechInfo(request.POST or None, instance=instance)
    queryset = TechLevel.objects.filter(id=id).values()
    context = {
        "instance": instance,
        "form": form,
...
def levelnewtech(request, id=None):
    form = TechInfo(request.POST)
    a = TechLevel.objects.values_list('id', flat=True).last()
    b = request.POST['level1_id']
    TechLevel.objects.filter(id=a).update(level=b)
    context = {
        "form": form,
    }
    return render(request, 'mha/addnewtechlevel.html', context)


def deletenewtech(request, id=None):
    form = TechInfo(request.POST)
    a = TechLevel.objects.values_list('id', flat=True).last()
    TechLevel.objects.filter(id=a).delete()
    context = {
        "form": form,
    }
    return render(request, 'mha/laborrates.html', context)


def ratenewtech(request, id=None):
    form = TechInfo(request.POST)
    a = TechLevel.objects.values_list('id', flat=True).last()
    b = request.POST['rate1_id']
    TechLevel.objects.filter(id=a).update(rate=b)
    context = {
        "form": form,
    }
    return render(request, 'mha/addnewtechlevel.html', context)
...
def addnewtechlevel(request):
    form = TechInfo()
    a = TechLevel.objects.values_list('id', flat=True).last()
    b = a + 1
    c = TechLevel.objects.create(id=b, idA=b)
    instance = TechLevel.objects.get(id=b)
    TechLevel.objects.filter(id=b).update(idA=b)
    d = TechLevel.objects.values_list('id', flat=True).last()
    queryset = TechLevel.objects.filter(idA=d)
    context = {
        "form": form,
        "instance": instance,
        "c": c,
...
def laborrates(request):
    queryset = TechLevel.objects.all()
    search_term = ''
...
def deletetech(request, id=None):
    instance = TechLevel.objects.get(id=id)
    form = TechInfo(request.POST or None)
    a = TechLevel.objects.filter(id=id).delete()
    context = {
        "instance": instance,
        "form": form,
        "a": a,
    }
    return redirect(instance.get_absolute16_url(), context)
...
def addnewequip2(request):
    ...
    a1 = a + 1
    b = Equipment2.objects.create(id=a1)
...
def equipselection2B(request, id=None):
    ...
    instance = get_object_or_404(EquipSelection, jobid=a, bidid=a2)
    instance2 = get_object_or_404(EquipSelection, bidid=a2)
    form = EquipmentSelect3(request.POST or None, instance=instance)
    queryset = CustomerInfo.objects.filter(id=b).values()
    c = Bidding.objects.filter(jobid=a).count()
    d = Bidding.objects.filter(bidid=a2).update(count=c)
    e = TargetProfit.objects.create(conid=a3, custid=a4, jobid=a, bidid=a2, targetprofit_id=0.15)
    ...
    return render(request, 'mha/equipselection3A.html', context)


def equipselection2C(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
    aa = EquipSelection.objects.filter(jobid=a, bidid=a2).update(optionid=1, options='Option A')
    ab = Bidding.objects.filter(jobid=a, bidid=a2).update(optionsid=1, options='Option A')
    ac = CurrentJobInfo.objects.filter(jobid=a, bidid=a2).update(optionid=1, options='Option A')
    b = CustomerInfo.objects.values_list('id', flat=True).last()
    CustomerInfo.objects.values_list('id', flat=True).last()
    c = SelectedEquip.objects.values_list('id', flat=True).last()or 0
    d1 = c + 1
    ...
    return render(request, 'mha/equipselection2C.html', context)
...
def equipselection3A(request, id=None):
    ...
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        return redirect(instance.get_absolute28_url())
...
def equipselection3B(request, id=None):
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
    aa = EquipSelection.objects.filter(jobid=a, bidid=a2).update(optionid=2, options='Option B')
    ab = Bidding.objects.filter(jobid=a, bidid=a2).update(optionsid=2, options='Option B')
    ac = CurrentJobInfo.objects.filter(jobid=a).update(optionid=2, options='Option B')
    b = CustomerInfo.objects.values_list('id', flat=True).last()
    CustomerInfo.objects.values_list('id', flat=True).last()
    c = SelectedEquip.objects.values_list('id', flat=True).last()or 0
    d1 = c + 1
...
def equipselection3C(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
...
def equipselection4B(request, id=None):
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
...
#        "ac": ac,
    ...
    return render(request, 'mha/equipselection4A.html', context)



def equipselection4C(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
...
def equipselection5A(request, id=None):
    ...
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
    aa = EquipSelection.objects.filter(jobid=a).update(optionid=4, options='Option D')
    ab = Bidding.objects.filter(jobid=a).update(optionsid=4, options='Option D')
    ac = CurrentJobInfo.objects.filter(jobid=a).update(optionid=4, options='Option D')
    b = CustomerInfo.objects.values_list('id', flat=True).last()
    CustomerInfo.objects.values_list('id', flat=True).last()
    c = SelectedEquip.objects.values_list('id', flat=True).last()or 0
    d1 = c + 1
...
def equipselection5B(request, id=None):
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
...
def equipselection5C(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
...
def equipselection6A(request, id=None):
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
    aa = EquipSelection.objects.filter(jobid=a).update(optionid=5, options='Option E')
    ab = Bidding.objects.filter(jobid=a).update(optionsid=5, options='Option E')
    ac = CurrentJobInfo.objects.filter(jobid=a).update(optionid=5, options='Option E')
    b = CustomerInfo.objects.values_list('id', flat=True).last()
    CustomerInfo.objects.values_list('id', flat=True).last()
    c = SelectedEquip.objects.values_list('id', flat=True).last()or 0
    d1 = c + 1
...
def equipselection6B(request, id=None):
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
    a4 = EquipSelection.objects.values_list('custid', flat=True).last()
...
def equipselection6C(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
...
def equipselection2D(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
...
def equipselection2E(request, id=None):
    FilterPlenumWidth.objects.all().delete()
    a = EquipSelection.objects.values_list('jobid', flat=True).last()
    a2 = EquipSelection.objects.values_list('bidid', flat=True).last()
    a3 = EquipSelection.objects.values_list('conid', flat=True).last()
...
def airhandler3a(request):
    FilterFurnbtu.objects.all().delete()
    a1 = EquipSelection.objects.values_list('bidid', flat=True).last()
    form = EquipmentSelect3(request.POST)
    b = request.POST['id_furntype'] or 0
    c = FurnaceType.objects.filter(id=b).values_list('furntype', flat=True) or 0
    d = EquipSelection.objects.filter(bidid=a1).update(airhandlertype=c, furntype=c)
    e1 = SelectedEquip.objects.filter(bidid=a1, id=1).update(type=c)
    ...
    try:
        ...
        h9 = 0
    try:
        h10 = FilterFurnbtu.objects.create(id=11, furnbtufilter=g[10])
    except Exception:
        h10 = 0
    context = {
        "form": form,
...
def conddescrip2A(request):
    ...
    ad = Bidding.objects.values_list('jobid', flat=True).last()
    TotalJobCost.objects.filter(descripid=1, jobid=ad).delete()
    form = EquipmentSelect1(request.POST)
    ...
    d3a = c.first()
    e = Equipment2.objects.filter(type='Condenser', eff=d1, btu=d2, mfgmodeldescrip=d3).values_list('modelnum',
                                                                                                    flat=True).last()
    e1 = Equipment2.objects.filter(type='Condenser', eff=d1, btu=d2, mfgmodeldescrip=d3).values_list('mfg',
                                                                                                    flat=True).last()
    e1a = Equipment2.objects.filter(type='Condenser', eff=d1, btu=d2, mfgmodeldescrip=d3).values_list('warr',
                                                                                                     flat=True).last()
    e1b = Equipment2.objects.filter(type='Condenser', eff=d1, btu=d2, mfgmodeldescrip=d3).values_list('cost',
                                                                                                      flat=True).last()
    ...
    d4 = SelectedEquip.objects.filter(equipid=1, bidid=a).update(quanity=1, mfgmodeldescrip=d3, modelnum=e, mfg=e1,
                                                                 warr=e1a, cost=e1b)

    d4a = Bidding.objects.filter(bidid=aa).update(jobtype1_id="Condenser", descript1_id=e, descript1b=4,
                                                  cost1total=e1b, quanity1=1)
    d16 = TotalJobCost.objects.create(jobid=ad, bidid=a, conid=ab, custid=ac, jobcost=e1b, descripid=1)
...
def coiltype2A(request):
    ...
    ac = Bidding.objects.values_list('custid', flat=True).last()
    ad = Bidding.objects.values_list('jobid', flat=True).last()
    TotalJobCost.objects.filter(descripid=2, jobid=ad).delete()
    ...
    d9 = d4.values_list('mfg', flat=True).distinct().last()
    d10 = d4.values_list('mfgmodeldescrip', flat=True).distinct().last()
    d11 = d4.values_list('warr', flat=True).distinct().last()
    d12 = d4.values_list('cost', flat=True).distinct().last()

    d13 = EquipSelection.objects.filter(bidid=a).update(coildescript=d10,coilmodnum=d5,coilheight=d6,coilwidth=d7,coildepth=d8)

    d14 = SelectedEquip.objects.filter(equipid=2, bidid=a).update(type='Evap. Coil', quanity=1, eff='N/A', mfg=d9, modelnum=d5,
                                                                 mfgmodeldescrip=d10, btu=d3, warr=d11, cost=d12)
    d15 = Bidding.objects.filter(bidid=a).update(jobtype2_id="Evap. Coil", descript2_id=d5, descript2b=5,
                                                 cost2total=d12, quanity2=1)
    d16 = TotalJobCost.objects.create(jobid=ad, bidid=a, conid=ab, custid=ac, jobcost=d12, descripid=2)
    context = {
        "form": form,
        "d": d,
        "d13": d13,
...
def addthermostat3A(request):
    ...
    d = EquipSelection.objects.filter(bidid=a).update(addthermostat=c)
    if b == '2':
        EquipSelection.objects.filter(bidid=a).update(targetseerrating=2)

        a2 = EquipSelection.objects.filter(bidid=a).values_list('furneff', flat=True).first()
        b2 = NicorRebate1.objects.values_list('rebate1eff', flat=True).first()
        c2 = RebateInfo.objects.values_list('furn97', flat=True).first()
        if a2 == b2:
            ...
            b3 = NicorRebate2.objects.values_list('rebate2eff', flat=True).first()
            c3 = RebateInfo.objects.values_list('furn95', flat=True).first()
            if a3 == b3:
                EquipSelection.objects.filter(bidid=a).update(vendor1rebate=c3)
            else:
                a4 = EquipSelection.objects.filter(bidid=a).values_list('furneff', flat=True).first()
                b4 = NicorRebate4.objects.values_list('rebate4eff', flat=True).first()
                c4 = RebateInfo.objects.values_list('furn96', flat=True).first()
                if a4 == b4:
                    EquipSelection.objects.filter(bidid=a).update(vendor1rebate=c4)
        ...
        return render(request, 'mha/equipselection3A.html', context)
         ...
         EquipSelection.objects.filter(bidid=a).update(targetseerrating=1)
         context = {
             "form": form,
             "d": d,
         }
...
def condmodnum(request):
    ...
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype1_id="Condenser", descript1_id=d1, descript1b=4, cost1total=d2b, quanity1=1)
...
def furnbtu3a(request):
    ...
    d1 = EquipSelection.objects.values_list('furnbtu', flat=True).last()
    d2 = FilterFurnModelnum.objects.create(id=1, furnmodelnumfilter="", furnheight=0.00, furnwidth=0.00)
    d3 = SelectedEquip.objects.filter(equipid=1, bidid=a).update(btu=d1)
    e = Equipment2.objects.filter(type='Furnace', btu=d1).annotate(configA=F('config'))
    g = list(e.values_list('config', flat=True).distinct())
    try:
        h = FilterFurnConfig.objects.create(id=1, furnconfigfilter=g[0])
    ...
    try:
        ...
        h3 = 0
    try:
        h4 = FilterFurnConfig.objects.create(id=5, furnconfigfilter=g[4])
    except Exception:
        h4 = 0
    try:
        h5 = FilterFurnConfig.objects.create(id=6, furnconfigfilter=g[5])
    except Exception:
        h5 = 0
    context = {
        "form": form,
...
def furneff3a(request):
    ...
    d3 = EquipSelection.objects.values_list('furneff', flat=True).last()
    d4 = FilterFurnModelnum.objects.create(id=1, furnmodelnumfilter="", furnheight=0.00, furnwidth=0.00)
    d5 = SelectedEquip.objects.filter(equipid=1, bidid=a).update(eff=d3)
    e = Equipment2.objects.filter(type='Furnace', btu=d1, config=d2, eff=d3).annotate(
        mfgmodeldescripA=F('mfgmodeldescrip'))
    g = list(e.values_list('mfgmodeldescrip', flat=True).distinct())
    try:
...
def load_furndescript3a(request):
    a = FilterFurnDescrip.objects.all()
    form = EquipmentSelect1(request.POST or None)
    furndescript = a.values('furndescripfilter')
    if form.is_valid():
    ...
    return render(request, 'mha/furndescript3A_1.html', context)
...
def furndescript3a(request):
    ...
    d3 = EquipSelection.objects.values_list('furneff', flat=True).last()
    d4 = EquipSelection.objects.values_list('furndescript', flat=True).last()
    d5 = SelectedEquip.objects.filter(id=1).update(mfgmodeldescrip=d4)
    e = Equipment2.objects.filter(type='Furnace', btu=d1, config=d2, eff=d3, mfgmodeldescrip=d4).annotate(
        modelnumA=F('modelnum'), heightA=F('height'), widthA=F('width'))
    g = list(e.values_list('modelnum', flat=True).distinct())
    g1 = list(e.values_list('height', flat=True).distinct())
...
def furnmodnum(request):
    ...
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype2_id="Furnace", descript2_id=d1, descript2b=6, cost2total=d2b, quanity2=1)
...
def furnmodnum3a(request):
    ...
    d2c = Equipment2.objects.filter(modelnum=d1).values_list('eff', flat=True)
    d2d = Equipment2.objects.filter(modelnum=d1).values_list('mfgmodeldescrip', flat=True)
    d3 = SelectedEquip.objects.filter(equipid=1, bidid=a).update(quanity=1, eff=d2c, mfg=d2, modelnum=d1,
                                                                 warr=d2a, cost=d2b)
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype1_id="Furnace", descript1_id=d1, descript1b=6, cost1total=d2b, quanity1=1)
    d5 = TotalJobCost.objects.create(bidid=a, conid=ab, custid=ac, jobcost=d2b, descripid=1)
    context = {
        "form": form,
        "d": d,
...
def coilmodnum(request):
    ...
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype3_id="Evap. Coil", descript3_id=d1, descript3b=5, cost3total=d2b, quanity3=1)
...
def thermomfg3a(request):
    ...
    d = EquipSelection.objects.filter(bidid=a).update(thermostat=c)
    d1 = EquipSelection.objects.values_list('thermostat', flat=True).last()
    d3 = SelectedEquip.objects.filter(equipid=2, bidid=a).update(type='Thermostat', mfg=d1)
...
def thermomfg2a(request):
    ...
    d = EquipSelection.objects.filter(bidid=a).update(thermostat=c)
    d1 = EquipSelection.objects.values_list('thermostat', flat=True).last()
    d3 = SelectedEquip.objects.filter(equipid=3, bidid=a).update(type='Thermostat', mfg=d1)
...
def load_thermomodnum2a(request):
    a = FilterThermostatModnum.objects.all()
    form = EquipmentSelect1(request.POST or None)
    thermostatmodnum = a.values('thermomodnum')
    if form.is_valid():
...
def thermostatmodnum(request):
    ...
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype4_id="Thermostat", descript4_id=d1, descript4b=9, cost4total=d2b, quanity4=1)
    ...
    if a3 == b3 and c3 == d3:
        ...
        if a2 == b2 and c2 == d2:
            ...
            a4 = EquipSelection.objects.filter(bidid=a).values_list('furneff', flat=True).first()
            b4 = NicorRebate4.objects.values_list('rebate4eff', flat=True).first()
            c4 = EquipSelection.objects.filter(bidid=a).values_list('smart', flat=True).first()
            d4 = NicorRebate3.objects.values_list('rebate3eff', flat=True).first()
            e4 = RebateInfo.objects.values_list('furntherm96', flat=True).first()
            if a4 == b4 and c4 == d4:
                EquipSelection.objects.filter(bidid=a).update(vendor1rebate=e4)
            else:
                ...
                if aa == bb:
                    ...
                    if aa == b1:
                        ...
                        a5 = EquipSelection.objects.filter(bidid=a).values_list('furneff', flat=True).first()
                        b5 = NicorRebate4.objects.values_list('rebate4eff', flat=True).first()
                        c5 = RebateInfo.objects.values_list('furn96', flat=True).first()
                        if a5 == b5:
                            EquipSelection.objects.filter(bidid=a).update(vendor1rebate=c5)
                        else:
...
def thermostatmodnum3a(request):
    a = EquipSelection.objects.values_list('bidid', flat=True).last()
    aa = Bidding.objects.values_list('bidid', flat=True).last()
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    ...
    d2c = Equipment2.objects.filter(modelnum=d1).values_list('eff', flat=True)
    d2d = Equipment2.objects.filter(modelnum=d1).values_list('mfgmodeldescrip', flat=True)
    d2 = SelectedEquip.objects.filter(equipid=2, bidid=aa).update(quanity=1, mfgmodeldescrip=d2d, modelnum=d1,
                                                                  btu='N/A', eff=d2c, warr=d2a, cost=d2b)
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype2_id="Thermostat", descript2_id=d1, descript2b=9, cost2total=d2b, quanity2=1)
    d5 = TotalJobCost.objects.create(bidid=a, conid=ab, custid=ac, jobcost=d2b, descripid=2)
    d3 = NicorRebate3.objects.values_list('rebate3eff', flat=True).first()
    e3 = RebateInfo.objects.values_list('furntherm97', flat=True).first()
    if a3 == b3 and c3 == d3:
...
def thermostatmodnum3an(request):
    a = EquipSelection.objects.values_list('bidid', flat=True).last()
    TotalJobCost.objects.filter(bidid=a, descripid=4).delete()
    form = EquipmentSelect3(request.POST)
...
def thermostatmodnum2a(request):
    a = EquipSelection.objects.values_list('bidid', flat=True).last()
    aa = Bidding.objects.values_list('bidid', flat=True).last()
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    ...
    d2c = Equipment2.objects.filter(modelnum=d1).values_list('eff', flat=True)
    d2d = Equipment2.objects.filter(modelnum=d1).values_list('mfgmodeldescrip', flat=True)
    d2 = SelectedEquip.objects.filter(equipid=3, bidid=aa).update(quanity=1, mfgmodeldescrip=d2d, modelnum=d1,
                                                                  btu='N/A', eff=d2c, warr=d2a, cost=d2b)
    d4 = Bidding.objects.filter(bidid=aa).update(jobtype3_id="Thermostat", descript3_id=d1, descript3b=9, cost3total=d2b, quanity3=1)
    d5 = TotalJobCost.objects.create(bidid=a, conid=ab, custid=ac, jobcost=d2b, descripid=3)
    d3 = NicorRebate3.objects.values_list('rebate3eff', flat=True).first()
    e3 = RebateInfo.objects.values_list('furntherm97', flat=True).first()
    if a3 == b3 and c3 == d3:
...
def bidpage4(request, bidid=None):
    FilterEquipType.objects.all().delete()
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    b = Bidding.objects.filter(bidid=bidid).values_list('custid', flat=True).last()
...
def jobtype1(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_jobtype1']
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype1_id=a, quanity1=0, descript1b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript1b(request, bidid=None):
    ...
    return render(request, 'mha/descript1b_1.html', context)



def descript1(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_descript1']
    d1 = Equipment2.objects.filter(modelnum=a).values_list("mfg")
    d2 = Equipment2.objects.filter(modelnum=a).values_list("btu")
    d3 = Equipment2.objects.filter(modelnum=a).values_list("mfgmodeldescrip")
    d4 = Equipment2.objects.filter(modelnum=a).values_list("warr")
    d4a = Equipment2.objects.filter(modelnum=a).values_list("eff") or 0
    d4b = Equipment2.objects.filter(modelnum=a).values_list("type")
...
def load_descript1(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript1 = Bidding.objects.values_list('descript1', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript1_1.html', context)


def quant1(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript1_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=1, jobcost=e, conid=ab, custid=ac)
...
def load_quanity1(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript1 = Bidding.objects.values_list('descript1', flat=True).get(bidid=bidid)
    if form.is_valid():
...
def delete1(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity1=0, descript1_id="Select Equipment",
                                               jobtype1="Select Equip. Type", descript1b="1", cost1total=0)
    SelectedEquip.objects.filter(equipid=1, bidid=bidid).update(quanity=None, type="", modelnum="", mfg="",
...
def jobtype2(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_jobtype2']
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype2_id=a, quanity2=0, descript2b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript2b(request, bidid=None):
    ...
    return render(request, 'mha/descript2b_1.html', context)



def descript2(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_descript2']
    d1 = Equipment2.objects.filter(modelnum=a).values_list("mfg")
    d2 = Equipment2.objects.filter(modelnum=a).values_list("btu")
    d3 = Equipment2.objects.filter(modelnum=a).values_list("mfgmodeldescrip")
    d4 = Equipment2.objects.filter(modelnum=a).values_list("warr")
...
def load_descript2(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript2 = Bidding.objects.values_list('descript2', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript2_1.html', context)


def quant2(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript2_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=2, jobcost=e, conid=ab, custid=ac)
...
def load_quanity2(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript2 = Bidding.objects.values_list('descript2', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/quan2_1.html', context)


def delete2(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity2=0, descript2_id="Select Equipment",
                                               jobtype2="Select Equip. Type", descript2b="1", cost2total=0)
    SelectedEquip.objects.filter(equipid=2, bidid=bidid).update(quanity=None, type="", modelnum="", mfg="",
                                                                mfgmodeldescrip="", btu="", eff="", warr="", cost=0.00)
...
def jobtype3(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_jobtype3']
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype3_id=a, quanity3=0, descript3b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript3b(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript3b = Bidding.objects.values('descript3b').get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript3b_1.html', context)



def descript3(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_descript3']
    d1 = Equipment2.objects.filter(modelnum=a).values_list("mfg")
    d2 = Equipment2.objects.filter(modelnum=a).values_list("btu")
    d3 = Equipment2.objects.filter(modelnum=a).values_list("mfgmodeldescrip")
    d4 = Equipment2.objects.filter(modelnum=a).values_list("warr")
...
def load_descript3(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript3 = Bidding.objects.values_list('descript3', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript3_1.html', context)


def quant3(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript3_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=3, jobcost=e, conid=ab, custid=ac)
...
def load_quanity3(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript3 = Bidding.objects.values_list('descript3', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/quan3_1.html', context)


def delete3(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity3=0, descript3_id="Select Equipment",
                                               jobtype3="Select Equip. Type", descript3b="1", cost3total=0)
    SelectedEquip.objects.filter(equipid=3, bidid=bidid).update(quanity=None, type="", modelnum="", mfg="",
                                                                mfgmodeldescrip="", btu="", eff="", warr="", cost=0.00)
...
def jobtype4(request, bidid=None):
    ...
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype4_id=a, quanity4=0, descript4b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript4b(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript4b = Bidding.objects.values('descript4b').get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript4b_1.html', context)



def descript4(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    a = request.POST['id_descript4']
    d1 = Equipment2.objects.filter(modelnum=a).values_list("mfg")
    d2 = Equipment2.objects.filter(modelnum=a).values_list("btu")
    d3 = Equipment2.objects.filter(modelnum=a).values_list("mfgmodeldescrip")
    d4 = Equipment2.objects.filter(modelnum=a).values_list("warr")
...
def load_descript4(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript4 = Bidding.objects.values_list('descript4', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript4_1.html', context)


def quant4(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript4_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=4, jobcost=e, conid=ab, custid=ac)
...
def load_quanity4(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript4 = Bidding.objects.values_list('descript4', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/quan4_1.html', context)


def delete4(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity4=0, descript4_id="Select Equipment",
                                               jobtype4="Select Equip. Type", descript4b="1", cost4total=0)
    SelectedEquip.objects.filter(equipid=4, bidid=bidid).update(quanity=None, type="", modelnum="", mfg="",
                                                                mfgmodeldescrip="", btu="", eff="", warr="", cost=0.00)
...
def jobtype5(request, bidid=None):
    ...
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype5_id=a, quanity5=0, descript5b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript5b(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript5b = Bidding.objects.values('descript5b').get(bidid=bidid)
    if form.is_valid():
...
def descript5(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
...
def load_descript5(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript5 = Bidding.objects.values_list('descript5', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript5_1.html', context)


def quant5(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript5_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=5, jobcost=e, conid=ab, custid=ac)
...
def delete5(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity5=0, descript5_id="Select Equipment",
                                               jobtype5="Select Equip. Type", descript5b="1", cost5total=0)
...
def jobtype6(request, bidid=None):
    ...
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype6_id=a, quanity6=0, descript6b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript6b(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript6b = Bidding.objects.values('descript6b').get(bidid=bidid)
    if form.is_valid():
...
def descript6(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
...
def load_descript6(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript6 = Bidding.objects.values_list('descript6', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript6_1.html', context)


def quant6(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript6_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=6, jobcost=e, conid=ab, custid=ac)
...
def delete6(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity6=0, descript6_id="Select Equipment",
                                               jobtype6="Select Equip. Type", descript6b="1", cost6total=0)
...
def jobtype7(request, bidid=None):
    ...
    b = Type.objects.filter(types=a).values_list('id', flat=True).first()
    Bidding.objects.filter(bidid=bidid).update(jobtype7_id=a, quanity7=0, descript7b=b)
    context = {
        "instance": instance,
        "form": form,
    }
...
def load_descript7b(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript7b = Bidding.objects.values('descript7b').get(bidid=bidid)
    if form.is_valid():
...
def descript7(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
...
def load_descript7(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    descript7 = Bidding.objects.values_list('descript7', flat=True).get(bidid=bidid)
    if form.is_valid():
    ...
    return render(request, 'mha/descript7_1.html', context)


def quant7(request, bidid=None):
    ...
    b = Bidding.objects.filter(bidid=bidid).values_list('descript7_id', flat=True).first()
    b1 = Equipment2.objects.filter(modelnum=b).values_list('cost', flat=True).first()
    ...
    ab = Bidding.objects.values_list('conid', flat=True).last()
    ac = Bidding.objects.values_list('custid', flat=True).last()
    i = TotalJobCost.objects.create(id=h, bidid=bidid, descripid=7, jobcost=e, conid=ab, custid=ac)
...
def delete7(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity7=0, descript7_id="Select Equipment",
                                               jobtype7="Select Equip. Type", descript7b="1", cost7total=0)
...
def descript8(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript8_id=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity8=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript8', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant8(request, bidid=None):
    ...
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript8', flat=True).first()
...
def delete8(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity8=0, descript8_id="Select Material", descript8b=1, cost8total=0)
#    Bidding.objects.filter(bidid=bidid).update(quanity8=0, descript8=1, descript8b=1, cost8total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=8).delete()
    MatCost.objects.filter(bidid=bidid, descript=8).delete()
    context = {
        "instance": instance,
...
def update8b(request, bidid=None):
 #   MatType.objects.all().delete()
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript8b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript9(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript9=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity9=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript9', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
#    #   Bidding.objects.filter(bidid=bidid).update(descript8=b)
#    Bidding.objects.filter(bidid=bidid).update(descript9=a)
#    Bidding.objects.filter(bidid=bidid).update(quanity9=1)
#    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    if aa == '2':
#        bb = Bidding.objects.filter(bidid=bidid).values_list('descript9', flat=True).first()
...
def update9b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript9b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript10(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript10=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity10=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript10', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant10(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript10', flat=True).first()
...
def update10b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript10b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript11(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript11=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity11=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript11', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant11(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript11', flat=True).first()
...
def delete11(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity11=0, descript11_id="Select Material", descript11b=1, cost11total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=11).delete()
    MatCost.objects.filter(bidid=bidid, descript=11).delete()
    context = {
        "instance": instance,
...
def update11b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript11b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript12(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript12=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity12=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript12', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant12(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript12', flat=True).first()
...
def delete12(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity12=0, descript12_id="Select Material", descript12b=1, cost12total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=12).delete()
    MatCost.objects.filter(bidid=bidid, descript=12).delete()
    context = {
        "instance": instance,
...
def update12b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript12b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript13(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript13=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity13=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript13', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant13(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript13', flat=True).first()
...
def delete13(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity13=0, descript13_id="Select Material", descript13b=1, cost13total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=13).delete()
    MatCost.objects.filter(bidid=bidid, descript=13).delete()
    context = {
        "instance": instance,
...
def update13b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript13b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript14(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript14=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity14=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript14', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant14(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript14', flat=True).first()
...
def delete14(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity14=0, descript14_id="Select Material", descript14b=1, cost14total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=14).delete()
    MatCost.objects.filter(bidid=bidid, descript=14).delete()
    context = {
        "instance": instance,
...
def update14b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript14b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript15(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript15=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity15=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript15', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant15(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript15', flat=True).first()
...
def delete15(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity15=0, descript15_id="Select Material", descript15b=1, cost15total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=15).delete()
    MatCost.objects.filter(bidid=bidid, descript=15).delete()
    context = {
        "instance": instance,
...
def update15b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript15b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript16(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript16=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity16=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript16', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant16(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript16', flat=True).first()
...
def delete16(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity16=0, descript16_id="Select Material", descript16b=1, cost16total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=16).delete()
    MatCost.objects.filter(bidid=bidid, descript=16).delete()
    context = {
        "instance": instance,
...
def update16b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript16b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript17(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript17=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity17=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript17', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant17(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript17', flat=True).first()
...
def delete17(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity17=0, descript17_id="Select Material", descript17b=1, cost17total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=17).delete()
    MatCost.objects.filter(bidid=bidid, descript=17).delete()
    context = {
        "instance": instance,
...
def update17b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript17b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript18(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript18=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity18=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript18', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant18(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript18', flat=True).first()
...
def delete18(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity18=0, descript18_id="Select Material", descript18b=1, cost18total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=18).delete()
    MatCost.objects.filter(bidid=bidid, descript=18).delete()
    context = {
        "instance": instance,
...
def update18b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript18b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript19(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript19=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity19=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript19', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant19(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript19', flat=True).first()
...
def delete19(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity19=0, descript19_id="Select Material", descript19b=1, cost19total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=19).delete()
    MatCost.objects.filter(bidid=bidid, descript=19).delete()
    context = {
        "instance": instance,
...
def update19b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript19b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript20(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript20=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity20=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript20', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant20(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript20', flat=True).first()
...
def delete20(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity20=0, descript20_id="Select Material", descript20b=1, cost20total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=20).delete()
    MatCost.objects.filter(bidid=bidid, descript=20).delete()
    context = {
        "instance": instance,
...
def update20b(request, bidid=None):
 #   MatType.objects.all().delete()
    ...
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript20b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
def descript21(request, bidid=None):
    ...
    a2 = Bidding.objects.filter(bidid=bidid).update(descript21=a)
    a3 = Bidding.objects.filter(bidid=bidid).update(quanity21=1)
    b = Bidding.objects.filter(bidid=bidid).values_list('descript21', flat=True).first()
#    b1 = MatTypeBid.objects.filter(id=b).values_list('type', flat=True).first()
    c = Material.objects.filter(descrip=a).values_list('cost', flat=True).first()
...
def quant21(request, bidid=None):
    ...
    aa = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    if aa == '1':
        bb = Bidding.objects.filter(bidid=bidid).values_list('descript21', flat=True).first()
...
def delete21(request, bidid=None):
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    Bidding.objects.filter(bidid=bidid).update(quanity21=0, descript21_id="Select Material", descript21b=1, cost21total=0)
    TotalJobCost.objects.filter(bidid=bidid, descripid=21).delete()
    MatCost.objects.filter(bidid=bidid, descript=21).delete()
    context = {
        "instance": instance,
...
def update21b(request, bidid=None):
 #   MatType.objects.all().delete()
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    a = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
#    b = MaterialType.objects.filter(id=a).values_list('id', flat=True).first()
    c = Bidding.objects.filter(bidid=bidid).update(descript21b=a)
    context = {
        "instance": instance,
        "form": form,
        "c": c,
...
#    d = MatType.objects.create(id=a, type=c)
    ...
    try:
        w1 = 1
        i = Material2.objects.create(id=w1, type=e1[0])
    except Exception:
        i = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w2 = w + 1
        i2 = Material2.objects.create(id=w2, type=e1[1])
    except Exception:
        i2 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w3 = w + 1
        i3 = Material2.objects.create(id=w3, type=e1[2])
    except Exception:
        i3 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w4 = w + 1
        i4 = Material2.objects.create(id=w4, type=e1[3])
    except Exception:
        i4 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w5 = w + 1
        i5 = Material2.objects.create(id=w5, type=e1[4])
    except Exception:
        i5 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w6 = w + 1
        i6 = Material2.objects.create(id=w6, type=e1[5])
    except Exception:
        i6 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w7 = w + 1
        i7 = Material2.objects.create(id=w7, type=e1[6])
    except Exception:
        i7 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w8 = w + 1
        i8 = Material2.objects.create(id=w8, type=e1[7])
    except Exception:
        i8 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w9 = w + 1
        i9 = Material2.objects.create(id=w9, type=e1[8])
    except Exception:
        i9 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w10 = w + 1
        i10 = Material2.objects.create(id=w10, type=e1[9])
    except Exception:
        i10 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w11 = w + 1
        i11 = Material2.objects.create(id=w11, type=e1[10])
    except Exception:
        i11 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w12 = w + 1
        i12 = Material2.objects.create(id=w12, type=e1[11])
    except Exception:
        i12 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w13 = w + 1
        i13 = Material2.objects.create(id=w13, type=e1[12])
    except Exception:
        i13 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w14 = w + 1
        i14 = Material2.objects.create(id=w14, type=e1[13])
    except Exception:
        i14 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w15 = w + 1
        i15 = Material2.objects.create(id=w15, type=e1[14])
    except Exception:
        i15 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w16 = w + 1
        i16 = Material2.objects.create(id=w16, type=e1[15])
    except Exception:
        i16 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w17 = w + 1
        i17 = Material2.objects.create(id=w17, type=e1[16])
    except Exception:
        i17 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w18 = w + 1
        i18 = Material2.objects.create(id=w18, type=e1[17])
    except Exception:
        i18 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w19 = w + 1
        i19 = Material2.objects.create(id=w19, type=e1[18])
    except Exception:
        i19 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w20 = w + 1
        i20 = Material2.objects.create(id=w20, type=e1[19])
    except Exception:
        i20 = 0
    try:
        w = Material2.objects.values_list('id', flat=True).last()
        w21 = w + 1
        i21 = Material2.objects.create(id=w21, type=e1[20])
    except Exception:
        i21 = 0
        context = {
            "instance": instance,
...
def materialtype3(request, bidid=None):
    Material3.objects.all().delete()
    instance = Bidding.objects.get(bidid=bidid)
    form = BidSelect(request.POST or None)
    c = Bidding.objects.filter(bidid=bidid).values_list('mattype', flat=True).first()
    e1 = Material.objects.filter(materialtype_id=c).annotate(descripA=F('descrip'))
    try:
        w1 = 1
        i = Material3.objects.create(id=w1, type=e1[0])
    except Exception:
        i = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w2 = w + 1
        i2 = Material3.objects.create(id=w2, type=e1[1])
    except Exception:
        i2 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w3 = w + 1
        i3 = Material3.objects.create(id=w3, type=e1[2])
    except Exception:
        i3 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w4 = w + 1
        i4 = Material3.objects.create(id=w4, type=e1[3])
    except Exception:
        i4 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w5 = w + 1
        i5 = Material3.objects.create(id=w5, type=e1[4])
    except Exception:
        i5 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w6 = w + 1
        i6 = Material3.objects.create(id=w6, type=e1[5])
    except Exception:
        i6 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w7 = w + 1
        i7 = Material3.objects.create(id=w7, type=e1[6])
    except Exception:
        i7 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w8 = w + 1
        i8 = Material3.objects.create(id=w8, type=e1[7])
    except Exception:
        i8 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w9 = w + 1
        i9 = Material3.objects.create(id=w9, type=e1[8])
    except Exception:
        i9 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w10 = w + 1
        i10 = Material3.objects.create(id=w10, type=e1[9])
    except Exception:
        i10 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w11 = w + 1
        i11 = Material3.objects.create(id=w11, type=e1[10])
    except Exception:
        i11 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w12 = w + 1
        i12 = Material3.objects.create(id=w12, type=e1[11])
    except Exception:
        i12 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w13 = w + 1
        i13 = Material3.objects.create(id=w13, type=e1[12])
    except Exception:
        i13 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w14 = w + 1
        i14 = Material3.objects.create(id=w14, type=e1[13])
    except Exception:
        i14 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w15 = w + 1
        i15 = Material3.objects.create(id=w15, type=e1[14])
    except Exception:
        i15 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w16 = w + 1
        i16 = Material3.objects.create(id=w16, type=e1[15])
    except Exception:
        i16 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w17 = w + 1
        i17 = Material3.objects.create(id=w17, type=e1[16])
    except Exception:
        i17 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w18 = w + 1
        i18 = Material3.objects.create(id=w18, type=e1[17])
    except Exception:
        i18 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w19 = w + 1
        i19 = Material3.objects.create(id=w19, type=e1[18])
    except Exception:
        i19 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w20 = w + 1
        i20 = Material3.objects.create(id=w20, type=e1[19])
    except Exception:
        i20 = 0
    try:
        w = Material3.objects.values_list('id', flat=True).last()
        w21 = w + 1
        i21 = Material3.objects.create(id=w21, type=e1[20])
    except Exception:
        i21 = 0
        context = {
            "instance": instance,
...
def techlevelhrs(request, bidid=None):
    ...
    d = Bidding.objects.filter(bidid=bidid).update(techhrs=a)
...
def load_techlevelhrs(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    techhrs = Bidding.objects.values_list('techhrs', flat=True).get(bidid=bidid)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
...
def techlevelhrs2(request, bidid=None):
    ...
    c = TechHours.objects.filter(id=a).values_list("hrstech", flat=True).first()
    d = Bidding.objects.filter(bidid=bidid).update(techhrs2=a)
...
def load_techlevel2hrs(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    techhrs2 = Bidding.objects.values_list('techhrs2', flat=True).get(bidid=bidid)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        return HttpResponseRedirect(instance.get_absolute1_url())
...
def techlevelhrs3(request, bidid=None):
    ...
    c = TechHours.objects.filter(id=a).values_list("hrstech", flat=True).first()
    d = Bidding.objects.filter(bidid=bidid).update(techhrs3=a)
...
def load_techlevel3hrs(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    techhrs3 = Bidding.objects.values_list('techhrs3', flat=True).get(bidid=bidid)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        return HttpResponseRedirect(instance.get_absolute1_url())
...
def techlevelhrs4(request, bidid=None):
    ...
    c = TechHours.objects.filter(id=a).values_list("hrstech", flat=True).first()
    d = Bidding.objects.filter(bidid=bidid).update(techhrs4=a)
...
def load_techlevel4hrs(request, bidid=None):
    instance = get_object_or_404(Bidding, bidid=bidid)
    form = BidSelect(request.POST or None, instance=instance)
    techhrs4 = Bidding.objects.values_list('techhrs4', flat=True).get(bidid=bidid)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        return HttpResponseRedirect(instance.get_absolute1_url())
    ...
    return render(request, 'mha/tech4hrs_1.html', context)
...
def package1b(request):
    ...
    t = Material.objects.filter(packageid=1).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage1a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost1=q)
    s = Material.objects.filter(packageid=1).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package2b(request):
    ...
    t = Material.objects.filter(packageid=2).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage2a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost2=q)
    s = Material.objects.filter(packageid=2).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package3b(request):
    ...
    t = Material.objects.filter(packageid=3).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage3a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost3=q)
    s = Material.objects.filter(packageid=3).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package4b(request):
    ...
    t = Material.objects.filter(packageid=4).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage4a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost4=q)
    s = Material.objects.filter(packageid=4).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package5b(request):
    ...
    t = Material.objects.filter(packageid=5).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage5a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost5=q)
    s = Material.objects.filter(packageid=5).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package6b(request):
    ...
    t = Material.objects.filter(packageid=6).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage6a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost6=q)
    s = Material.objects.filter(packageid=6).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package7b(request):
    ...
    t = Material.objects.filter(packageid=7).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage7a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost7=q)
    s = Material.objects.filter(packageid=7).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package8b(request):
    ...
    t = Material.objects.filter(packageid=8).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage8a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost8=q)
    s = Material.objects.filter(packageid=8).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package9b(request):
    ...
    t = Material.objects.filter(packageid=9).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage9a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost9=q)
    s = Material.objects.filter(packageid=9).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package10b(request):
    ...
    t = Material.objects.filter(packageid=10).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage10a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost10=q)
    s = Material.objects.filter(packageid=10).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package11b(request):
    ...
    t = Material.objects.filter(packageid=11).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage11a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost11=q)
    s = Material.objects.filter(packageid=11).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package12b(request):
    ...
    t = Material.objects.filter(packageid=12).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage12a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost12=q)
    s = Material.objects.filter(packageid=12).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package13b(request):
    ...
    t = Material.objects.filter(packageid=13).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage13a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost13=q)
    s = Material.objects.filter(packageid=13).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package14b(request):
    ...
    t = Material.objects.filter(packageid=14).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage14a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost14=q)
    s = Material.objects.filter(packageid=14).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package15b(request):
    ...
    t = Material.objects.filter(packageid=15).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage15a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost15=q)
    s = Material.objects.filter(packageid=15).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def package16b(request):
    ...
    t = Material.objects.filter(packageid=16).update(cost=q)
    context = {
        "form": form,
        "g": g,
        "l": l,
...
def deletepackage16a(request, id=None):
    ...
    q = o['p'] or 0
    r = PackageInfo.objects.filter(id=1).update(cost16=q)
    s = Material.objects.filter(packageid=16).update(cost=q)
    if form.is_valid():
        instance = form.save(commit=False)
        instance.save()
        context2 = {
...
def acceptchangename1(request, id=None):
    ...
    Material.objects.filter(packageid=1).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename2(request, id=None):
    ...
    Material.objects.filter(packageid=2).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename3(request, id=None):
    ...
    Material.objects.filter(packageid=3).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename4(request, id=None):
    ...
    Material.objects.filter(packageid=4).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename5(request, id=None):
    ...
    Material.objects.filter(packageid=5).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename6(request, id=None):
    ...
    Material.objects.filter(packageid=6).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename7(request, id=None):
    ...
    Material.objects.filter(packageid=7).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename8(request, id=None):
    ...
    Material.objects.filter(packageid=8).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename9(request, id=None):
    ...
    Material.objects.filter(packageid=9).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename10(request, id=None):
    ...
    Material.objects.filter(packageid=10).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename11(request, id=None):
    ...
    Material.objects.filter(packageid=11).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename12(request, id=None):
    ...
    Material.objects.filter(packageid=12).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename13(request, id=None):
    ...
    Material.objects.filter(packageid=13).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename14(request, id=None):
    ...
    Material.objects.filter(packageid=14).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename15(request, id=None):
    ...
    Material.objects.filter(packageid=15).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
...
def acceptchangename16(request, id=None):
    ...
    Material.objects.filter(packageid=16).update(descrip=a)
    context = {
        "instance": instance,
        "form": form,
